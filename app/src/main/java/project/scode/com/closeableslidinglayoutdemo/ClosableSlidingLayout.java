...
class ClosableSlidingLayout extends FrameLayout {
    ...
    View mTarget;
    boolean swipeable = true;//是否滑动（抽动）
    ...
    private float mInitialMotionY;//最初的Y?
    private boolean collapsible = false;//可折叠的
    private float yDiff;
    ...
    public ClosableSlidingLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        MINVEL = getResources().getDisplayMetrics().density * 400;//400dp
    }
    ...
    private void dismiss(View view, float yvel) {
        ...
        ViewCompat.postInvalidateOnAnimation(ClosableSlidingLayout.this);//配合使用??
    }
